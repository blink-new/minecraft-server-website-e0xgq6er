const HomePage = () => {
  return (
    <div className="relative min-h-screen bg-gray-800 text-white flex flex-col">
      {/* Full-width Banner */}
      ...
      {/* Content aligned with sidebar top */}
      <div className="flex-1 flex justify-center items-start">
        <div className="w-full max-w-4xl -mt-32 md:-mt-40 lg:-mt-48 relative z-10">
          <div className="bg-gray-900/80 backdrop-blur-sm p-8 rounded-lg shadow-2xl border border-gray-700">
